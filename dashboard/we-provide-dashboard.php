 ...
 */
function we_provide_remove_widgets() {
  remove_meta_box( 'dashboard_primary', 'dashboard', 'side' );
  remove_meta_box( 'dashboard_secondary', 'dashboard', 'side' );
}

add_action('wp_dashboard_setup', 'we_provide_remove_widgets');
 ...
 * @return Null   Returns null
 */
function we_provide_search_engine_notice_text() {
 ...
 * @return Null   Returns null
 */
function we_provide_search_engine_notice() {
  if( current_user_can( 'manage_options' ) ) {
    add_meta_box( 'my_dashboard_widget', 'LET OP!', 'we_provide_search_engine_notice_text', 'dashboard', 'side', 'high' );
  }
}

if( !get_option( 'blog_public' ) ) {
    add_action( 'wp_dashboard_setup', 'we_provide_search_engine_notice' );
}
?>
